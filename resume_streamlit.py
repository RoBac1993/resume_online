...
PAGE_TITLE = 'Digitaler CV | Robert Bachmeier'
PAGE_ICON = ':man_in_tuxedo:'
NAME = 'Robert Bachmeier'
DESCRIPTION = '''Lead Controller Asset Management, 
                 enhance customer portfolios by providing meaningful insights.'''
...
AUSZEICHNUNG = { 'Auszeichnung für die Entwicklung einer Smart Beta Portfoliostrategie mit dem Faktor "Growth in Net Operating Assets'}
...
with st.expander('Hobbys', True):
     ...
     lottie_fitness = load_lottieurl('https://lottie.host/94b76f9b-2e96-4f3b-89e4-d480836c1350/k1GRBWMpOd.json')#online url
     lottie_fitness2 = load_lottiefile("lottiefiles/fitness.json") #filepath
     with fitness:
          st_lottie(
             lottie_fitness2,
             speed= 1,
          ...
          st.markdown("<p style='text-align: center; ;'> Fitnessstudio </p>", unsafe_allow_html=True)
                      # '''
     lottie_e_sports = load_lottieurl('https://lottie.host/13f92670-2a67-4155-ac0e-96382cab333b/tHS6oZ7i3e.json') #online url
     lottie_e_sports2 = load_lottiefile("lottiefiles/esport.json") #filepath
     with e_sports:
          st_lottie(
            lottie_e_sports2,
            speed= 1,
     ...
     lottie_reading = load_lottieurl('https://lottie.host/4dd2c353-bd4f-4fdc-9339-347d51e086ca/XxwfuiTs39.json')   #online url
     lottie_reading2 = load_lottiefile("lottiefiles/reading2.json") #filepath
     with reading:
          st_lottie(
           lottie_reading2,
           speed= 1,
     ...
     lottie_hiking = load_lottieurl('https://lottie.host/c6f2ad68-d646-4f5d-924b-36113dc00672/OSG09IN4H7.json') #online url
     lottie_hiking2 = load_lottiefile("lottiefiles/hiking2.json") #filepath
     with hiking:
          st_lottie(
           lottie_hiking2,
           speed= 1,
